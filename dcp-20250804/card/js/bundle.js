...
document.addEventListener('DOMContentLoaded', () => {
  ...
  elCloseVideoPanel.onclick = () => {
    elVideo.currentTime = 0;
    elVideo.removeEventListener('timeupdate', timeupdateCallback);
  ...
  elShortVideo.addEventListener('click', () => {
    ...
    // NOTE: メインビデオを再生開始
    elVideo.addEventListener('timeupdate', timeupdateCallback);
    elVideo.play();
  });
